...
final class MainStartupAction: StartupAction {
    ...
    private let transformer: ThreeStepTransformerAction<String, Result<(search: PhotoService, favorite: PhotoService), Error>, UIWindow, Void>
    
    
    init(withImgurClientId clientId: String,
         step1: TransformerStartupAction<String, Result<(search: PhotoService, favorite: PhotoService), Error>>,
         step2: TransformerStartupAction<Result<(search: PhotoService, favorite: PhotoService), Error>, UIWindow>,
