...
final class MainStartupAction: StartupAction {
    ...
    private let transformer: ThreeStepTransformerAction<String, Result<PhotoService, Error>, UIWindow, Void>
    
    
    init(withImgurClientId clientId: String,
         step1: TransformerStartupAction<String, Result<PhotoService, Error>>,
         step2: TransformerStartupAction<Result<PhotoService, Error>, UIWindow>,
